...
public class ApplicationFeatureProviderGoogleImpl extends ApplicationFeatureProviderImpl {
    private static final boolean DEBUG = Log.isLoggable("AppFeatureProviderGImpl", Log.DEBUG);
    ...
    public CharSequence getTimeSpentInApp(String str) {
        try {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.Q) {
                call = this.mContext.getContentResolver().call("com.google.android.apps.wellbeing.api", "get_app_usage_millis", (String) null, bundle);
            }
            if (call != null) {
