...
public class AwarePreferenceController extends TogglePreferenceController implements DialogInterface.OnClickListener, LifecycleObserver, OnStart, OnStop, AwareHelper.Callback {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mPref = (SwitchPreference) preferenceScreen.findPreference(getPreferenceKey());
    }
    ...
    public int getAvailabilityStatus() {
        return (!this.mHelper.isSupported() || this.mHelper.isAirplaneModeOn()) ? 5 : 0;
    }
    ...
    public void onClick(DialogInterface dialogInterface, int i) {
        if (i == -1) {
            ...
            this.mPref.setChecked(false);
        } else if (i == -2) {
            this.mPref.setChecked(true);
        }
    }
