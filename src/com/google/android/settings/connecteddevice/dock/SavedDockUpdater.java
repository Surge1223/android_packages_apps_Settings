...
public class SavedDockUpdater implements DockUpdater, DockAsyncQueryHandler.OnQueryListener {
    ...
    public void registerCallback() {
        ContentProviderClient acquireContentProviderClient = this.mContext.getContentResolver().acquireContentProviderClient(DockContract.DOCK_PROVIDER_SAVED_URI);
    ...
    private SingleTargetGearPreference initPreference(String str, String str2) {
        ...
        if (context != null) {
            SingleTargetGearPreference singleTargetGearPreference = new SingleTargetGearPreference(context, (AttributeSet) null);
            singleTargetGearPreference.setIcon((int) R.drawable.ic_dock_24dp);
    ...
    private void updateConnectedDevice(List<DockDevice> list) {
        ...
        this.mConnectedDockId = list.get(0).getId();
