...
public class SurveyFeatureProviderImpl implements SurveyFeatureProvider, LoaderManager.LoaderCallbacks<HatsDownloadRequest> {
    ...
    public static class SurveyProviderLoader extends AsyncLoader<HatsDownloadRequest> {
        ...
        private String getAdsId() {
            try {
                FutureTask futureTask = new FutureTask(new C1592x29ae0c0d(this));
        ...
        public /* synthetic */ Bundle lambda$getAdsId$0$SurveyFeatureProviderImpl$SurveyProviderLoader() throws Exception {
            return getContext().getContentResolver().call(PROXY_AUTHORITY, "getAdsClientId", (String) null, (Bundle) null);
        }
    }
    ...
    public boolean showSurveyIfAvailable(Activity activity, String str) {
        ...
        return HatsClient.showSurveyIfAvailable(builder.build());
    }
