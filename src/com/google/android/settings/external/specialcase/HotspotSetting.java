...
public class HotspotSetting implements Queryable {
    ...
    /* renamed from: com.google.android.settings.external.specialcase.HotspotSetting$1 */
    class C15701 extends ConnectivityManager.OnStartTetheringCallback {
        C15701() {
        }
    }
    ...
    private void updateHotspot(ConnectivityManager connectivityManager, int i) {
        if (i == 1) {
            connectivityManager.startTethering(0, true, new C15701());
        } else {
